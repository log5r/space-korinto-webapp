...
const messages = {
  "ja": {
    ...
    "handle": "操作は下の壁にある<b>青く光るハンドルゲージ</b>だけ。ハンドルを回している間、玉は自動で連続発射（毎分 100 発）。弱いと左に、強いと右に落ちるので、狙いたい場所に合わせて強さを調整しよう。いちばん左に戻すと発射が止まります。<b>ノーマル・タイムアタック：</b>中段のゲートが10秒ごとに左右へ傾きます。2秒前の予告を見て、左は弱め・右は強めに打ち分けよう。ノーマルは点灯側が通常配当、反対側は得点半分・賞球なし。タイムアタックは点灯側の得点2倍、反対側は通常得点。切り替え直後の1秒間は両側2倍。中央は常に通常得点で、時間延長はありません。",
